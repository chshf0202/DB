...
module.exports = {
  ...
  systemName: '“飨味通”点菜系统',         //系统名称
  copyright: '2023 陈绍锋 曹伯炜 张辰珏 联合出品',     //copyright
  ...
  footerLinks: [                        //页面底部链接，{link: '链接地址', name: '名称/显示文字', icon: '图标，支持 ant design vue 图标库'}
    {link: 'https://wechat.com', icon: 'wechat'},
    {link: 'https://scse.buaa.edu.cn/', name: '北京航空航天大学计算机学院'},
    {link: 'https://qq.com', icon: 'qq'}
  ],
}
